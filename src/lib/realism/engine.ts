...
export const CHAOS_EVENTS: ChaosEvent[] = [
  ...
  { text: '限定甜点排到最后一份，正好落在{{char}}手上，后面那人只能笑着认了。', flavor: 'fortune' },
  { text: '{{char}}抽的盲盒开出她最想要的那款，连店员都说今天这位运气好。', flavor: 'fortune' },
  { text: '商场满减差的那一块钱，{{char}}在外套口袋里翻出一枚硬币刚好补上。', flavor: 'fortune' },
  { text: '{{char}}的伞骨坏了那天，出租车在她面前停下，司机摆摆手说这趟不收钱。', flavor: 'fortune' },
  { text: '咖啡店把{{char}}的订单做错了，于是赔给她一份刚出炉的巴斯克。', flavor: 'fortune' },
  { text: '{{char}}随手写的便签被店长夸了一句，还被贴在了员工墙上。', flavor: 'fortune' },
  { text: '两人刚走到站台，末班车就缓缓进站，司机多等了十秒才关门。', flavor: 'fortune' },
  { text: '{{char}}在旧外套口袋摸到一张洗过但还能用的电影兑换券。', flavor: 'fortune' },
  { text: '花店老板娘顺手多塞给{{char}}一支花，说是今天多出来的。', flavor: 'fortune' },
  { text: '{{char}}的手机关机前最后一点电，刚好撑到她扫码付款成功。', flavor: 'fortune' },
  { text: '雨停在两人推门出去的那一刻，云缝里正好漏下一道天光。', flavor: 'fortune' },
  { text: '{{char}}在图书馆随手抽的书里夹着一张上一位读者留下的书签和票根。', flavor: 'fortune' },
  { text: '楼里的电梯在{{char}}跑到门口时重新打开，里面的人一直按着开门键。', flavor: 'fortune' },
  { text: '{{char}}在跳蚤市场淘到的旧相机，装上电池居然还能用。', flavor: 'fortune' },
  { text: '两人要排的那条队临时多开了一个窗口，正好轮到他们先走。', flavor: 'fortune' },
  // 🔴 厄运
  ...
  { text: '{{char}}的耳机只剩一边出声了，偏偏是在她听得入神的时候。', flavor: 'misfortune' },
  { text: '奶茶封口没压好，第一口就洒在了{{char}}刚换的白衬衫上。', flavor: 'misfortune' },
  { text: '{{char}}刚吹好的头发被一辆洒水车浇了个正着。', flavor: 'misfortune' },
  { text: '手机系统更新卡在最后一步，{{char}}盯着转圈等了二十分钟。', flavor: 'misfortune' },
  { text: '{{char}}的快递被放到了隔壁楼，取件码却写着她这一栋。', flavor: 'misfortune' },
  { text: '咖啡洒在键盘上，{{char}}倒过来甩了两下，越甩越糟。', flavor: 'misfortune' },
  { text: '{{char}}排了四十分钟的队，轮到她时收银机恰好故障了。', flavor: 'misfortune' },
  { text: '一阵风把{{char}}的帽子卷到了马路对面的灌木丛里。', flavor: 'misfortune' },
  { text: '{{char}}要付钱时才发现这层楼没信号，付款码转了三圈还是失败。', flavor: 'misfortune' },
  { text: '{{char}}的高跟鞋鞋跟卡进了路面砖缝，怎么拔都拔不出来。', flavor: 'misfortune' },
  { text: '{{char}}的伞被风整个吹翻，骨架朝上像一只盛开的碗。', flavor: 'misfortune' },
  { text: '楼上滴下来的水，在{{char}}刚晾好的衬衫上留下一串水印。', flavor: 'misfortune' },
  { text: '{{char}}的会员卡刚好在今天过期，积分清零的提示弹了出来。', flavor: 'misfortune' },
  { text: '{{char}}的新袜子后跟挂了个小洞，偏偏今天要换鞋进门。', flavor: 'misfortune' },
  { text: '外带的汤盒没扣紧，回到家才发现袋子湿了一片。', flavor: 'misfortune' },
  ...
  { text: '隔壁装修的电钻声从早上就没停过，说话都得提高音量。', flavor: 'chaos' },
  { text: '商场广播反复播报寻人启事，找的是一个穿黄外套的小孩。', flavor: 'chaos' },
  { text: '店里的空调突然开始滴水，正好滴在两人那张桌子的正中间。', flavor: 'chaos' },
  { text: '有人把外卖电动车横在门口，堵住了唯一的出口。', flavor: 'chaos' },
  { text: '一群人举着灯牌涌进来拍照，把两人挤到了角落。', flavor: 'chaos' },
  { text: '街对面在放烟花彩排，一声接一声，说什么都得等它响完。', flavor: 'chaos' },
  { text: '餐厅临时换了菜单，{{char}}刚想好的那道菜被划掉了。', flavor: 'chaos' },
  { text: '隔壁桌把短视频外放，声音一次比一次大。', flavor: 'chaos' },
  { text: '忽然跳闸又来电，店里所有电器同时重启，滴滴声响成一片。', flavor: 'chaos' },
  { text: '楼上开始拖家具，一阵一阵，连店里的音乐都压不住。', flavor: 'chaos' },
  // 💜 离谱
  ...
  { text: '{{char}}的相册里凭空多出一张两人从没拍过的合照，时间就是昨天。', flavor: 'wild' },
  { text: '一个路人认真地告诉{{char}}，她今天会遇到一个改变计划的人，说完就走了。', flavor: 'wild' },
  { text: '{{char}}收到一份快递，寄件人那一栏写着"你自己"。', flavor: 'wild' },
  { text: '街角那面墙上出现了写着{{char}}名字的涂鸦，颜料还是新的。', flavor: 'wild' },
  { text: '店里那台老式收音机，忽然念出了{{char}}刚才只在心里想过的一句话。', flavor: 'wild' },
  { text: '一只猫跟着两人走了三条街，每次回头它都端端正正地坐着。', flavor: 'wild' },
  { text: '{{char}}发现今天是旧日历上被圈起来的日子，可她怎么也想不起为什么。', flavor: 'wild' },
  { text: '手机导航把两人导进一条死胡同，尽头却挂着一串风铃。', flavor: 'wild' },
  // 🎪 滑稽
  ...
  { text: '{{char}}想优雅地撩一下头发，手指却被发夹绕住了，越解越乱。', flavor: 'slapstick' },
  { text: '{{char}}喝汤前吹了一口气，热气糊满眼镜，眼前一片白。', flavor: 'slapstick' },
  { text: '{{char}}起身时带了一下桌布，杯子晃出半圈水痕。', flavor: 'slapstick' },
  { text: '{{char}}的鞋在楼梯上打滑，她扶住栏杆才没摔，姿势像在跳芭蕾。', flavor: 'slapstick' },
  { text: '{{char}}对着手机说了半天，才发现通话早就断了。', flavor: 'slapstick' },
  { text: '{{char}}签字时笔没墨了，甩了两下，墨点溅到了自己袖口。', flavor: 'slapstick' },
  { text: '{{char}}想悄悄后退一步，脚跟撞上消防栓，整个人弹了一下。', flavor: 'slapstick' },
  { text: '{{char}}把盐当成糖撒进了咖啡，喝下去的表情一言难尽。', flavor: 'slapstick' },
  { text: '{{char}}的围巾被门夹住了，她往前一走又被拽了回来。', flavor: 'slapstick' },
  { text: '{{char}}笑到一半打了个嗝，两个人都愣了一秒。', flavor: 'slapstick' },
  { text: '{{char}}打了个喷嚏，手里的勺子飞出去，正好插在蛋糕上。', flavor: 'slapstick' },
  { text: '{{char}}戴着耳机跟着唱，摘下耳机才发现整个车厢都听见了。', flavor: 'slapstick' },
  { text: '{{char}}边下楼梯边回消息，最后两级直接踩空，靠弹跳站住了。', flavor: 'slapstick' },
  // 🌶️ spicy（默认关闭）
  ...
  { text: '情侣卡座只剩最后一张，服务员笑眯眯地引两人过去，桌子中间只隔一盏小蜡烛。', flavor: 'chaos', spicy: true },
  { text: '影院好座位都被占了，两人只能挤在最后一排的连体座上，扶手怎么也放不下来。', flavor: 'chaos', spicy: true },
  { text: '试衣间的帘子卡住了一半，{{char}}只好叫{{user}}过去帮忙拉住。', flavor: 'chaos', spicy: true },
  { text: '电梯超载铃响，最后进来的两人只能贴着站，谁都没敢先动。', flavor: 'chaos', spicy: true },
  { text: '旅馆只剩一间房，老板娘说外头下着大雪，今晚退不了房。', flavor: 'chaos', spicy: true },
  { text: '两人被雨困在同一个电话亭里，肩膀到肩膀没有一点空隙。', flavor: 'chaos', spicy: true },
  { text: '停电的那一瞬间{{char}}抓住了身边的手，来电后才发现那只手一直没松开。', flavor: 'chaos', spicy: true },
  { text: '{{char}}的吊带滑落了一半，她一边说完那句话一边不动声色地拉回去。', flavor: 'wild', spicy: true },
  { text: '自动售货机把{{char}}买的那瓶水卡住了，{{user}}伸手进去掏，两人凑得很近。', flavor: 'wild', spicy: true },
  { text: '照片打印机一次吐出两张，多出来的那张是{{char}}从没给任何人看过的自拍。', flavor: 'wild', spicy: true },
  { text: '{{char}}分了一半耳机给{{user}}，曲子恰好是她自己录的一段清唱。', flavor: 'wild', spicy: true },
  { text: '两人共用的毯子滑下去一半，{{char}}顺手盖回来时按住了{{user}}的手。', flavor: 'wild', spicy: true },
  { text: '{{char}}的香水味留在了{{user}}的外套上，第二天被同事闻了出来。', flavor: 'wild', spicy: true },
  { text: '便利店收银员笃定两人是夫妻，{{char}}抢着解释的声音越来越小。', flavor: 'wild', spicy: true },
  { text: '{{char}}的裙带松了一路，她拽着{{user}}的手腕让他帮忙挡着走完这条街。', flavor: 'wild', spicy: true },
  { text: '猜拳输了，{{char}}必须贴着{{user}}的耳朵说一句话，说完自己先红了。', flavor: 'wild', spicy: true },
  { text: '{{char}}裹着浴巾出来拿外卖，门一开正好遇上敲错门的邻居。', flavor: 'slapstick', spicy: true },
  { text: '{{char}}的浴袍带子松了，她一手按住一手去接电话，电话那头是{{user}}。', flavor: 'slapstick', spicy: true },
  { text: '{{char}}穿着{{user}}的衬衫当睡衣，被推门进来的人一言不发地看了三秒。', flavor: 'slapstick', spicy: true },
  { text: '{{char}}在湿地板上打了个滑，整个人扑进{{user}}怀里，两个人都僵住了。', flavor: 'slapstick', spicy: true },
  { text: '{{char}}想展示新买的睡衣，转身时才发现窗帘根本没拉上。', flavor: 'slapstick', spicy: true },
]
