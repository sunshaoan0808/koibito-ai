...
| Tier 5 信息架构 | **3/4**（设置搜索 ✅、拆分 Generation 页 ✅、级联来源可视化 ✅ 2026-09-14；交叉链接 2/4 ⏳ 同日） | ~~L382~~ / ~~L395~~ / ~~L397~~ / L400 | ~~拆分 Generation 设置页~~、~~设置搜索~~、~~级联来源可视化（`InheritanceBadge`，三面全接）~~、剩余：更多交叉链接（见 TODO L431，其中 2/4 已落地 2026-09-14） |
