...
| 🔢 修正数字 | 测试"800+"→ **116 文件 / ~2,156 用例**（P1-1 交付后为 **117 文件 / 2,170 用例**；P1-2 交付后为 **117 文件 / 2,191 用例**；P1-3 交付后为 **117 文件 / 2,192 用例**；P2 批次交付后为 **125 文件 / 2,431 用例**；P2-6 扶正卡补丁后为 **125 文件 / 2,432 用例**；P1-4 桥 + P2-5 代码侧后为 **127 文件 / 2,451 用例**；有声书（P2-3 后半）后为 **128 文件 / 2,469 用例**）；Chaos 事件"24 个"→ **152 条**（P1-3 扩容后实测，`tools/audit/count_chaos_pool.py`）；i18n 从"待做"→ **已完成**；`strict: true` 从"待开启"→ **已开启** |
