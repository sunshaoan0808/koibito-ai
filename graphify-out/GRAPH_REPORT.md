...
## Corpus Check
- 448 files · ~4,310,029 words
- Verdict: corpus is large enough that graph structure adds value.

## Summary
- 2904 nodes · 8718 edges · 151 communities (134 shown, 17 thin omitted)
- Extraction: 99% EXTRACTED · 1% INFERRED · 0% AMBIGUOUS · INFERRED: 63 edges (avg confidence: 0.75)
- Token cost: 0 input · 0 output

## Graph Freshness
- Built from commit: `a05f70f5`
...
- 4-file cycle: `src/lib/dating/aftercare.ts -> src/lib/dating/relationshipAssist.ts -> src/lib/dating/expectations.ts -> src/lib/types.ts -> src/lib/dating/aftercare.ts`
- 4-file cycle: `src/lib/dating/aftercare.ts -> src/lib/dating/relationshipAssist.ts -> src/lib/dating/intent.ts -> src/lib/types.ts -> src/lib/dating/aftercare.ts`
- 4-file cycle: `src/lib/dating/aftercare.ts -> src/lib/dating/relationshipAssist.ts -> src/lib/dating/plans.ts -> src/lib/types.ts -> src/lib/dating/aftercare.ts`
- 4-file cycle: `src/lib/dating/aftercare.ts -> src/lib/dating/relationshipAssist.ts -> src/lib/dating/stage.ts -> src/lib/types.ts -> src/lib/dating/aftercare.ts`
- 4-file cycle: `src/lib/dating/aftercare.ts -> src/lib/dating/relationshipAssist.ts -> src/lib/prompt/builder.ts -> src/lib/types.ts -> src/lib/dating/aftercare.ts`
...
- 4-file cycle: `src/lib/dating/aftercare.ts -> src/lib/dating/relationshipAssist.ts -> src/lib/types.ts -> src/lib/dating/intimacyScene.ts -> src/lib/dating/aftercare.ts`
...
- 4-file cycle: `src/lib/dating/intimacyScene.ts -> src/lib/dating/intimacyStages.ts -> src/lib/store/useSettingsStore.ts -> src/lib/types.ts -> src/lib/dating/intimacyScene.ts`
...
### Community 20 - "app.ts"
Cohesion: 0.07
Nodes (17): BACKUP_STORES, clientDir, DEFAULT_SCENE_FLAGS, GIFT_RARITIES, normalizeClearableIntimacyLevel(), normalizeIntimacyLevel(), normalizeItemDefs(), normalizeItemEffect() (+9 more)
...
### Community 47 - "db.ts"
Cohesion: 0.09
Nodes (19): assistantThreadStore, characterStore, chatFactStore, chatStore, ColumnSpec, db, __dirname, instructTemplateStore (+11 more)
...
Cohesion: 0.11
Nodes (19): autoprefixer, devDependencies, autoprefixer, postcss, tailwindcss, @types/express, @types/react, @types/react-dom (+11 more)
...
### Community 149 - "server/index.ts"
Cohesion: 0.29
Nodes (7): app, purgeChat(), purgeExpiredTrash(), checkpointDb(), dataDir, shutdown(), runSeedIfNeeded()
